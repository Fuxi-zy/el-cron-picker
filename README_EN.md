...
| 1.2.1          | ①. Moved croner to devDependencies to avoid duplicate installation for consumers ②. Replaced isCron regex with croner native parser for consistent validation ③. Removed sloppyRanges to ensure standard cron expression output ④. Added debounce to nextRunTimes and watch numberCount changes ⑤. Added virtual scrolling for run times list, supporting large datasets (10000+) with smooth rendering ⑥. Upgraded vite 8.0.10, vue 3.5.33, element-plus 2.13.7 | 2026-04-30   |
| 1.2.2          | Fixed the issue where selecting the "Specify" option without choosing values, then switching to another option and back, the radio button would reset to "Every"                                                                                                                                                                                                                                                                               | 2026-06-12   |
